...
app, rt = star_app(
    ...
    hdrs=[
        ...
        Style("""
            ...
            .tool-btn:focus-visible { outline: 2px solid #93c5fd; outline-offset: -2px; }
            .tool-btn:focus:not(:focus-visible) { outline: none; }
            .tool-btn.selected { background: #dbeafe; color: #1d4ed8; }
            .tool-btn.selected:hover { background: #bfdbfe; }
            ...
            .action-btn[disabled="true"] { opacity: 0.3; cursor: not-allowed; pointer-events: none; }
            ...
            /* ── Color trigger (stroke fills whole swatch; fill inset when enabled) ── */
            .color-trigger {
            ...
            .color-trigger:hover { box-shadow: 0 0 0 2px rgba(0,0,0,0.15); }
            .color-trigger:focus-visible { outline: 2px solid #93c5fd; outline-offset: 1px; }
            .color-trigger-fill {
                position: absolute;
                inset: 4px;
                border-radius: 4px;
            ...
            .panel-section-header .panel-label { margin-bottom: 0; }
            .panel-value {
            ...
            .style-btn.selected { background: #dbeafe; border-color: #93c5fd; color: #1d4ed8; }

            /* ── Width button dots ── */
            .width-btn { width: 32px; height: 32px; padding: 0; }
            .width-dot { border-radius: 50%; background: currentColor; }

            /* ── Dash previews ── */
            .dash-preview { width: 24px; height: 2px; }
            .dash-preview.solid { background: currentColor; }
            .dash-preview.dashed { background: repeating-linear-gradient(90deg, currentColor 0 6px, transparent 6px 10px); }
            .dash-preview.dotted { background: repeating-linear-gradient(90deg, currentColor 0 2px, transparent 2px 6px); }
            ...
            .styled-slider.full-width { width: 100%; }
            ...
            .styled-slider::-webkit-slider-thumb:active { cursor: grabbing; }
            ...
            /* ── Responsive: scroll tools on narrow viewports ── */
            @media (max-width: 640px) {
                ...
                .toolbar-popover { min-width: 200px; }
            }
        """),
    ],
)
...
canvas = DrawingCanvas(name="drawing", style="position:fixed;inset:0;width:100%;height:100%;background:white;touch-action:none;z-index:0;")
